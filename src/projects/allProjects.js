export const ALL_PROJECTS = [
  {
    title: 'Lingo',
    github: 'https://github.com/movntains/Lingo',
    external: 'https://lingo.surge.sh/',
    internal: '',
    description:
      'A React app that uses the Yandex Translate API to translate words and/or phrases. HTTP GET requests are made with Axios.',
    tech: ['Axios', 'Flexbox', 'React', 'Sass', 'Yandex Translate API'],
    tag: 'front-end'
  },
  {
    title: 'Lyric Finder',
    github: 'https://github.com/movntains/Lyric-Finder',
    external: 'https://lyricfinder.surge.sh/',
    internal: '',
    description:
  ...
  },
  {
    ...
    github: 'https://github.com/movntains/Mountain-Calling',
    external: 'https://mountaincalling.herokuapp.com/',
    internal: '',
    description:
  ...
  {
    title: 'Sick Fits',
    github: 'https://github.com/movntains/Sick-Fits',
    external: '',
    internal: '',
    description:
  ...
  {
    title: 'Work It',
    github: 'https://github.com/movntains/Work-It',
    external: 'https://work-it.surge.sh/',
    internal: '',
    description:
